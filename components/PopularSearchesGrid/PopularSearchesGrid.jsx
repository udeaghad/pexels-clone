  ...
  return (
    <div>
      <div className="flex flex-col justify-center items-center mt-10 px-3 mb-5">
        <h1 className="text-[33px] font-semibold text-gray-700">
          Popular Searches
        </h1>
        <p className="text-[18px] text-center font-medium text-gray-600">
          The most popular search terms on Pexels
        </p>
      </div>
          ...
          collections.map((collection) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex justify-center items-center flex-col px-5">
                <span className="text-[33px] font-semibold text-white text-center">
                  {collection.title}
                </span>
              </div>
              ...
              <div className="absolute bottom-0 top-[30%] right-0 left-0 flex justify-center items-center flex-col sm:top-[45%] lg:top-[30%]">
                <span
                  ...
                  className="hidden text-white text-xl text-center"
                >
                  {collection.photos_count} photos . {collection.videos_count}{" "}
                  videos
                </span>
              </div>
            </div>
