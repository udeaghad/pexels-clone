...
const Trending = () => {
  ...
  return (
    <div className="mt-8 flex flex-col justify-start items-start px-5 w-full">
      <div className='flex justify-between items-center w-full'>
        ...
        <div className="h-12 border rounded-md flex justify-center items-center py-1 px-3 text-base text-gray-500 gap-2" onClick={(e) => showOptions(e)}>
