...
import { FaSquareYoutube } from "react-icons/fa";
...
const socialMediaItems = [
  {name: "Facebook", link: "#", icon: <RiFacebookFill className="text-white text-2xl"/>},
  {name: "Twitter", link: "#", icon: <FaTwitter className="text-white text-2xl"/>},
  {name: "Instagram", link: "#", icon: <BsInstagram className="text-white text-2xl"/>},
  {name: "Pinterest", link: "#", icon: <FaPinterestP className="text-white text-2xl"/>},
  {name: "Youtube", link: "#", icon: <FaSquareYoutube className="text-white text-2xl"/>},
]
