...
export default function Trending(props) {
    ...
    return (
        ...
        <div className="h-[auto] border-solid border-2 border-indigo-600 items-center font-normal
         flex sm:w-[500px] lg:w-[700px] sm:truncate lg:truncate" data-testid="trending-topics">
            ...
            <div>
                <IconContext.Provider value={{ className: "border-none text-slate-100 text-3xl fill-white" }}>
                    <Link href={more}><CiCircleMore /></Link>
